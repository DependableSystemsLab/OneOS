...
import { validateFilePath } from '../utils/validation.jsx';
...
const ApplicationBuilder = ({ sys }) => {
    ...
    function saveInfo(){
        if(!validateFilePath(nodePath)){
            ...
            Swal.fire(
                'Changes saved!',
                'Node data modified successfully',
                'success',
            )
        }
    }
        ...
        <div className="dndflow" style={{
            ...
            <div style={{ flex: 1, borderLeft: "1px solid #ccc" }}>
                ...
                <form class="ui form updatenode_controls" style={{ display: selectedNode ? "block" : "none" }}>
                    ...
                    <Button color='green' onClick={() => saveInfo()}>Save</Button>
                </form>
