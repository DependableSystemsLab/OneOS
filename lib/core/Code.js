...
Code.bootstrap = function(local_module, main, code_uri, user_meta){
  ...
  if (process.connected){
    ...
    var pubsub = new Pubsub.IPCChild(process.oneos.pubsub_ipc, process.oneos.pubsub_url);
    var streams = {
      output: {},
      input: {}
    };
    ...
    // ipc.connectTo('oneos-runtime', process.agentID+'.ipc.sock', ()=>{
    //   ipc.of['oneos-runtime'].on('connect', ()=>{
    //     console.log(process.agentID+' Child Connected to IPC Server');
    //   });
    //   ipc.of['oneos-runtime'].on('disconnect', ()=>{
    //     console.log(process.agentID+' Child Disconnected');
    //   });
    ...
    // process.input = function(name){

    // };
    // process.output = function(name){
